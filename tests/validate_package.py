...
REQUIRED = [
    ...
    "harness/catalog/external-components.lock.json",
    ...
    "skills/bravecow-onboarding/references/action-branches.md",
    "skills/bravecow-onboarding/references/completion-evidence.md",
    "skills/bravecow-onboarding/references/domain-patterns.md",
    "skills/bravecow-onboarding/references/lesson-loop.md",
    "skills/bravecow-onboarding/references/method-skills.md",
    "skills/bravecow-onboarding/references/project-personalization.md",
    "skills/bravecow-onboarding/references/route-builder.md",
    "skills/bravecow-onboarding/references/spoken-copy.md",
    "skills/bravecow-onboarding/references/ui-visual-coverage.md",
    "skills/bravecow-onboarding/references/video-distillation-BV1dFTv6yEcZ.md",
    "skills/bravecow-onboarding/references/zcode-computer-use-plugin.md",
    ...
    "tests/smoke_zcode_computer_use.ps1",
