...
Generated: 2026-08-01T10:03:45.014227+00:00
...
- Config runtime gate: `pass-legacy-fast-alias`
- Codex CLI: `codex-cli 0.130.0-alpha.5`
- Last measured startup prompt: `11505` tokens
- Skill descriptions: `3051` tokens across `74` catalog entries
- Prompt probe mode: `legacy-fast-alias`
- Config gate diagnostic: `bundled CLI schema lags the current official config schema; remaining config validated with legacy service_tier=fast alias`
...
- Incremental updates this run: `0`
- Retrieval router result: `fts`
- Retrieval degradation latency: `258.22 ms`
- Durable-memory write gate: `accept`; writes performed: `False`
- Graphiti passive port health: `unavailable` (no service startup attempted)
...
- Previous-lock drift snapshot: `ready`; changes: `5`
...
- Resolved plugin skill entries: `66`
...
- `codex-cli`: declared `0.130.0-alpha.5`, installed `0.130.0-alpha.5`, state `drift`, rollback `dd4adf302b112fdc30fce509a5e261a0a6f1118dc58ac2da636eb84e0a6b3e3e`
